package com.nahid.nfood.CustomerFoodPanel;
...
import com.nahid.nfood.Chef;
import com.nahid.nfood.ChefFoodPanel.UpdateDishModel;
import com.nahid.nfood.Customer;
import com.nahid.nfood.CustomerFoodPanel_BottomNavigation;

import com.nahid.nfood.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                assert cust != null;
                Division = cust.getDivision();
                City = cust.getCity();

                RandomId = getIntent().getStringExtra("FoodMenu");
                ChefID = getIntent().getStringExtra("ChefId");

                databaseReference = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(Division).child(City).child(ChefID).child(RandomId);
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String pri = "<b>" + "Price: BDT. " + "</b>" + updateDishModel.getPrice();
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    if (ChefID.equals(cart1.getChefId())) {
                                        data = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(Division).child(City).child(ChefID).child(RandomId);
