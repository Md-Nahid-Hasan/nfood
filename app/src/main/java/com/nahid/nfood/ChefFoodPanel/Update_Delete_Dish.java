...
import com.nahid.nfood.ChefFoodPanel_BottomNavigation;
...
public class Update_Delete_Dish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(Division).child(City).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(ID).removeValue();
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(Division).child(City).child(useridd).child(ID);
    ...
    private void updatedesc(String uri) {
        ...
        firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(Division).child(City)
