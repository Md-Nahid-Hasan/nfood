                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(Division).child(City).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUId)
