package com.nahid.nfood.ChefFoodPanel;
...
import com.nahid.nfood.SendNotification.APIService;
import com.nahid.nfood.SendNotification.Client;
import com.nahid.nfood.SendNotification.Data;
import com.nahid.nfood.SendNotification.MyResponse;
import com.nahid.nfood.SendNotification.NotificationSender;
    ...
    private void CheforderdishesView() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                                        ...
                                        FirebaseDatabase.getInstance().getReference("ChefFinalOrders")
                                                ...
                                                .child(RandomUID).child("Dishes").child(dishid).setValue(hashMap);
                                    }
                                    DatabaseReference data = FirebaseDatabase.getInstance()
                                            .getReference("ChefWaitingOrders")
                                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                                            ...
                                            FirebaseDatabase.getInstance().getReference("ChefFinalOrders")
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    FirebaseDatabase.getInstance()
                                                            .getReference("CustomerFinalOrders")
                                                            .child(userid).child(RandomUID)
                                                            .child("OtherInformation").child("Status")
                                                            .setValue("Chef is preparing your order...")
                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        @Override
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            FirebaseDatabase.getInstance()
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                number.setText("+880" + chefWaitingOrders1.getMobileNumber());
